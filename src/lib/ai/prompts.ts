...
export const COMPILE_SYSTEM_PROMPT = [
  ...
  "- Drop and projectile base predictions must NOT include testChange; they",
  "  describe the rendered base scene as-is.",
  "- In every counterfactual, set prediction.testChange identical to that",
  "  counterfactual's change (or omit it; the server fills it in).",
  ...
  "  projectile: flight completes; pendulum: two periods).",
  ...
  "- Reuse the learner's own key words from sourceQuestion (for example",
  "  heavier, faster, farther) in the title, objective, and prediction text",
  "  so the lab visibly answers their question in their words.",
