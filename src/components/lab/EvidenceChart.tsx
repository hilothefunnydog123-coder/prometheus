...
import type { ExperimentSpec } from "@/src/lib/contracts/experiment";
import type { SimulationEvidence } from "@/src/lib/physics/evidence";
    ...
    <div className="chart-wrap" aria-label={`Evidence chart showing ${labels.join(" and ")}`}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={evidence.points} margin={{ top: 8, right: 8, bottom: 0, left: -20 }}>
          ...
          <XAxis dataKey="time" tickFormatter={(value) => Number(value).toFixed(1)} stroke="#5f7380" tick={{ fill: "#7f929e", fontSize: 10 }} axisLine={false} tickLine={false} />
