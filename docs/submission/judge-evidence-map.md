...
| Generated experiments match the actual question | Post-schema question-alignment checks, including terminal velocity | `src/lib/ai/question-alignment.ts` | Three mechanics families only |
...
- Do not claim user studies, learning-outcome improvements, teacher quotes, or
  adoption numbers.
- Do not claim support for physics outside drop, projectile, and pendulum.
